---
title: "Ejercicio 3: Pajaro and Piedra — Selective Interface Implementation"
sidebarTitle: "Pajaro & Piedra"
description: "Compare Pajaro (which implements Cantante) with Piedra (which implements Volador), demonstrating selective interface adoption and how interfaces can be used to model surprising or ironic behavior contracts."
---
